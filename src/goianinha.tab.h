...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    LEIA = 267,                    /* LEIA  */
    ESCREVA = 268,                 /* ESCREVA  */
    NOVALINHA = 269,               /* NOVALINHA  */
    IGUAL = 270,                   /* IGUAL  */
    IGUAL_IGUAL = 271,             /* IGUAL_IGUAL  */
    ...
    E = 282,                       /* E  */
    OU = 283,                      /* OU  */
    PONTO_VIRGULA = 284,           /* PONTO_VIRGULA  */
    VIRGULA = 285,                 /* VIRGULA  */
    ABRE_PAREN = 286,              /* ABRE_PAREN  */
    FECHA_PAREN = 287,             /* FECHA_PAREN  */
    ABRE_CHAVE = 288,              /* ABRE_CHAVE  */
    FECHA_CHAVE = 289,             /* FECHA_CHAVE  */
    ID = 290,                      /* ID  */
    STRING_CONST = 291,            /* STRING_CONST  */
